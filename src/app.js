(function(win, doc, nav) {
    win.PUSH_SERVER_TOOL = {
        init: function(options) {
            ...
            const pushButtonSelector = options.pushButton;
            const userLang = navigator.language || navigator.userLanguage;

            doc.addEventListener("DOMContentLoaded", () => {
                let isPushEnabled = false;

                const pushButton = doc.querySelector(pushButtonSelector);
                if (!pushButton) {
                    return;
                }
                ...
                function push_updateSubscription() {
                    nav.serviceWorker.ready.then(serviceWorkerRegistration => serviceWorkerRegistration.pushManager.getSubscription())
                        .then(subscription => {
                            changePushButtonState('disabled');
